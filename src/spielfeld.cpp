...
//#define DEBUG_SPIELFELD

Spielfeld::Spielfeld(const QVector3D & center, GLfloat squareSize)
    :GLBody("4Gewinnt")
{
    m_center = center;
    m_normal = v_Y;
...
/**
  ...
  */
QVector3D Spielfeld::fieldToPosition(QPoint field)
{
//    QMatrix4x4 m;
...
void Spielfeld::makeSurface(QVector<GLPoint> *pointContainer, QVector<IndexType> *indexContainer)
{
...
/**
  ...
  */
void Spielfeld::raiseDisc(GLDisc * disc, QPoint field, bool jumpOverKing)
{
...
/**
  ...
  */
bool Spielfeld::isOnBoard(const QVector3D & position)
{
    return
